...
$page_layout_meta = Xiomi_Group_Fields_Value::page_layout('xiomi');
$page_container_meta = Xiomi_Group_Fields_Value::page_container('xiomi','container_options');
...
if ('blank' == $page_layout_meta['layout']):
	...
	?>
    <div id="primary" class="content-area xiomi-page-content-area padding-120 page-content-wrap-<?php the_ID(); ?> <?php echo esc_attr($full_width_class);?>">
